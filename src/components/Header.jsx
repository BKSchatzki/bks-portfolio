...
function Header({ handleThemeSwitch, theme }) {
  return (
    <header className="sticky top-0 z-10 mx-auto flex h-fit w-full items-center justify-center bg-gradient-to-r from-yellow-500 to-pink-500 text-center text-xs shadow-2xl duration-100 dark:from-pink-700 dark:to-yellow-700 dark:shadow-neutral-900">

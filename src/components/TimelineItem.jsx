  ...
  return (
    <ol className="relative flex flex-col border-l border-stone-200 dark:border-slate-700">
      <li className="mb-8 ml-4 mr-4">
        ...
        <div className="flex flex-row flex-wrap items-center justify-start gap-4 text-[0.625rem] sm:text-xs lg:text-sm">
          ...
          <span className="my-1 text-xs font-normal leading-none opacity-40 sm:text-sm lg:text-base">
            {duration}
          </span>
        </div>
        <p className="my-2 text-sm font-normal opacity-60 sm:text-base lg:text-lg">
          {details}
        </p>
      </li>
    </ol>
